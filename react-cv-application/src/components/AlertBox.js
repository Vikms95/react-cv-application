				...
				{this.props.isRequiredFieldsValid() ? (
					<section>
						...
						<div className="alert--box--buttons">
							<button onClick={this.props.toggleMode} className="alert--box--button">
								{' '}
                                Proceed{' '}
							</button>

							<button
								onClick={this.props.removeAlertBox}
					...
					<section>
						<div className="alert--box--text">
							...
							<span className="alert--highlight"> phone</span> fields in order to
                            proceed.
						</div>
					</section>
				)}
